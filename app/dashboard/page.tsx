...
export default function DashboardPage() {
  // This page is a fallback. Middleware will redirect to the appropriate dashboard
  // or to /auth/login when unauthenticated. We intentionally avoid client redirects here
  // to prevent loops.
  // Inline LogoIcon to match the branded loading used on the login page
      ...
      <div className="text-center">
        <div className="flex flex-col items-center space-y-6">
          ...
          <div className="flex items-baseline space-x-4">
            <h1 className="text-4xl font-black">Future</h1>
            <div className="w-1 h-10 bg-primary/70 rounded-full"></div>
            <span className="text-3xl font-light text-muted-foreground">Cashflow</span>
          </div>
