    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-white/95 backdrop-blur-lg border-0 shadow-2xl rounded-3xl max-w-2xl">
        ...
        <div className="space-y-6">
          ...
          {/* Application Summary */}
          <div className="bg-gradient-to-r from-blue-50/80 to-purple-50/80 backdrop-blur-sm p-6 rounded-xl border-0 shadow-lg space-y-3">
            <h3 className="font-semibold bg-gradient-to-r from-blue-700 to-purple-700 bg-clip-text text-transparent mb-4">
              Application Summary
            </h3>
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="font-semibold text-gray-900">
                {application.verified_documents} verified, {application.rejected_documents} rejected of{" "}
                {application.document_count} total
              </span>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              <Button
                ...
                className={`flex-1 py-4 px-6 rounded-xl shadow-lg transition-all duration-300 hover:scale-105 ${
                  decision === "approve"
                    ? "bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white shadow-xl"
                    : "bg-white/70 backdrop-blur-sm border-0 hover:bg-white/90 text-gray-700"
                }`}
          ...
          <div className="space-y-3">
            ...
            <Textarea
              ...
              rows={4}
              className="border-0 bg-white/70 backdrop-blur-sm shadow-lg rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500/50 focus:bg-white/90 transition-all duration-300 placeholder:text-gray-500 resize-none"
            />
          </div>

          {decision === "reject" && !notes.trim() && (
            <Alert className="border-blue-200 bg-blue-50/80 backdrop-blur border-0 shadow-lg rounded-xl">
        ...
        <DialogFooter className="pt-6">
          <Button 
            ...
            className="bg-white/70 backdrop-blur-sm border-0 shadow-lg hover:bg-white/90 hover:scale-105 transition-all duration-300 px-6 py-3 rounded-xl"
          >
            Cancel
          </Button>
          <Button 
            ...
            className={`px-6 py-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 disabled:hover:scale-100 disabled:opacity-50 font-semibold ${
              decision === "approve"
